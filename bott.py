...
km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='ErxgsWZNka15YvFN4VOd.oEIB/s3Rr9E51pit4yenRq.pScJ+hfqerAMB7bsITU19hCgSqBSUZxYPtR7WEvNseg=')
km.loginResult()
...
admin=["ud5c39db7ab34ca5fb15f99ffef31047f","u39e89bf92deb47d7b9d4f213e1810dad","u7347c230e0c899ad5b63ce75f572b106","uac6ffdd8b1703b6cadedcf8dfd1215cf"]
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        random.choice(KAC).sendText(op.param1, "nah " + "☞ " + nick[0] + " ☜" + "\nNgintip Aja Niih(-__-)   ")
                                    else:
                                        random.choice(KAC).sendText(op.param1, "Haii " + "☞ " + nick[1] + " ☜" + "\nCCTV ")
                                else:
                                    random.choice(KAC).sendText(op.param1, "ketauan " + "☞ " + Name + " ☜" + "\nCCTV Kak\nSini Gabung Chat...   ")
                        else:
                            pass
                    else:
                        pass
...
#		    cl.sendText(msg.to,"Khusus bay")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "ud5c39db7ab34ca5fb15f99ffef31047f"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
	    ...
	    elif "mptri " in msg.text:
					songname = msg.text.replace("mptri ","")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                kc.sendImageWithURL(msg.to,pilih)
                ...
                try:
                    ...
                    cl.sendImageWithURL(msg.to, bay)
                ...
                try:
                    ...
                    kk.sendText(msg.to,'https://www.youtube.com' + results['href'])
                except:
                    ...
                    try:
                        ...
                        soup = BeautifulSoup(html, "html.parser")
                        results = soup.find(attrs={'class': 'yt-uix-tile-link'})
                        kk.sendVideoWithURL(msg.to,'https://www.youtube.com' + results['href'])
                    except:
                        cl.sendText(msg.to, "Could not find it")                    
...
#              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Tapi masih cakep juga")
                ki.sendText(msg.to,"Tak tun tuang")
                kk.sendText(msg.to,"Tak tun tuang")
                cl.sendText(msg.to,"apalagi kalau sudah mandi")
                ki.sendText(msg.to,"Tak tun tuang")
                kk.sendText(msg.to,"Pastinya cakep sekali")
