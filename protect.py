...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="EqGOGCZ0jGWtn9K0Io8f.Rg+92lfWo2YT7C/n+rivZW.EKT4oq3E1X4BJnl7uIvjH1doxwSxYZGgwNdkBzP27yk=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token="Eq85c6dIto9gZ5Ze1Ky6.H2hLIeUwny7G0OQeYMppTG.E8M/19wknE0+CCdWHUgQe9Ehbr+k2ojSfOB/VR4NkqY=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="Eq6FPz50Prqx0Rac7eZ9.aX69s+8VHHX8+TIz5so52q.CZNFBncnNhVye30w5++JpLuEyKxKCpPq0oxmcX4plsw=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
ki.login(token="EqLuiE746IIWuTlDuZz0.+qBpV8E+/wZBHli68Pjr0a.NiPG+s7y6IuP8t6VM1HcPZfC99AeE8anujYr1znR1YY=")
ki.loginResult()
#fawn
kk = LINETCR.LINE()
kk.login(token="EqAQunIGccNxC4Ug7V4e.x5MvPa4bCunGKJgtTwS1RG.rooWkpUYbwsnueixW0GZcp5TKtQ+CSixFICrbo/dz4U=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE()
kc.login(token="ErONXLn82tDCbrUtH3x5.M9qYBwS+M7YDRKA51zb21q.Wto8RRQm/NOtQRsVEpeJr8bIzkbB6Kt4regtq05se3U=")
kc.loginResult()

#kicker ghost
kl = LINETCR.LINE()
kl.login(token="ErxgsWZNka15YvFN4VOd.oEIB/s3Rr9E51pit4yenRq.pScJ+hfqerAMB7bsITU19hCgSqBSUZxYPtR7WEvNseg=")
kl.loginResult()
...
admin = ["ud5c39db7ab34ca5fb15f99ffef31047f","u39e89bf92deb47d7b9d4f213e1810dad","udf6c3490f0e0f4205f088804076c03a0","u7347c230e0c899ad5b63ce75f572b106","u1db5875ab422e045f6133711b5103321","ub423e2c77e72692a5db5d1647af9341c"]
...
#============================================================================
        ...
        if op.type == 26:
            ...
            elif msg.text in ["Key kicker","help kicker","Help kicker"]:
                cl.sendText(msg.to,kickerMessage)
...
#------------------------------------------------
              ...
              if msg.from_ in admin:
                ki.sendText(msg.to,"PONG ����􀄻double thumbs up􀜁􀅔  Har Har")
...
#============================================
            ...
            elif msg.text.lower() in ["Tagall","Tag all","Mention all"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
