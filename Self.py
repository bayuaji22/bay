...
cl = LINETCR.LINE()
cl.login(token="EqucnxZIkc5FV8THA0Jd.oEIB/s3Rr9E51pit4yenRq.q93rtt6nTxMqSzyJhk+X631wTT9n5rDBKpBknI07FtM=")
cl.loginResult()
...
creator=["u39e89bf92deb47d7b9d4f213e1810dad"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u39e89bf92deb47d7b9d4f213e1810dad"}
