...
ka = LINETCR.LINE()
ka.login(token="ErxgsWZNka15YvFN4VOd.oEIB/s3Rr9E51pit4yenRq.pScJ+hfqerAMB7bsITU19hCgSqBSUZxYPtR7WEvNseg=")
ka.loginResult()
...
Bots=[mid]
admin=["ud5c39db7ab34ca5fb15f99ffef31047f","u39e89bf92deb47d7b9d4f213e1810dad"]
...
#==============================================================================#           
                ...
                wait["Sider"] = True
                ka.sendText(msg.to,"Berhasil Mengaktifkan Cek Sider")
#==============================================================================#
            elif "Sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    ka.sendText(msg.to, "Berhasil Menonaktifkan Cek Sider")
                else:
...
#------------------------
        if op.type == 26:
            ...
            if msg.text in ["Assalamualaikum","Asalamualaikum","Assallammuallaikum"]:
                ka.sendText(msg.to,"Walaikumsalam Wr Wb 👳")
            if msg.text in ["Pagi","pagi","Selamat pagi","Selamat Pagi"]:
                ka.sendText(msg.to,"Pagi juga ")
            if msg.text in ["Siang","siang","Selamat siang","Selamat Siang"]:
                ka.sendText(msg.to,"Siang ")
            if msg.text in ["Malam","malam","Selamat malam","Selamat Malam"]:
                ka.sendText(msg.to,"Malam ")
            if msg.text in ["Sore","sore","Selamat sore","Selamat Sore"]:
                ka.sendText(msg.to,"Sore")
            if msg.text in ["Doni","doni","don","Don"]:
                ka.sendText(msg.to,"Jangan Panggil Panggil kangen Pm aja")
#------------------------
        if op.type == 59:
            print op
