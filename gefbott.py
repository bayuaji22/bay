                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        random.choice(KAC).sendText(op.param1, "CCTV " + "☞ " + nick[0] + " ☜" + "\nNgintip aja kk (-__-)   ")
                                    else:
...
#		    cl.sendText(msg.to,"Khusus zhu")
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
                ...
                cl.sendMessage(msg)
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    cl.sendText(msg.to,_name + " cek Hadiahmu")
                                    msg.contentType = 9
                                    msg.contentMetadata= {'PRDTYPE': 'STICKER',
                                                         'STKVER': '1',
                                                         'MSGTPL': '1',
		...
		cl.sendText(msg.to,"Absen Grak!!")
                cl.sendText(msg.to," Paimin Hadiir  \(ˆ▿ˆ)/")
                cl.sendText(msg.to," Prapto Hadiir  \(ˆ▿ˆ)/")
                cl.sendText(msg.to," Parji Hadiir  \(ˆ▿ˆ)/")
                cl.sendText(msg.to," Mbok Sundari Hadiir  \(ˆ▿ˆ)/")
                cl.sendText(msg.to,"Semua Hadirr gracl...!")
              ...
              if msg.from_ in Creator:
                ...
                cl.sendAudio(msg.to,"hasil.mp3")
                    ...
                    cl.sendText(msg.to,beb)        
                                ...
                                beb = "PAgi 😘 " +cl.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
                                cl.sendText(msg.to,beb)
                                
            elif msg.text.lower() in ["sore","Sore"]:
                                beb = "Sore 😘 " +cl.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
                                cl.sendText(msg.to,beb)        
                                
            elif msg.text.lower() in ["malam","Malam"]:
                                beb = "Malam 😘 " +cl.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
                                cl.sendText(msg.to,beb)                    

            elif msg.text.lower() in ["bot","Bot","Mbok","mbok"]:
                            beb = "Hadirr 😘 " +cl.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
                            cl.sendText(msg.to,beb)
                                ...
                                cl.sendText(msg.to,beb)
            elif msg.text.lower() in ["Salken","salken","Salam kenal"]:
                                beb = "Sal Ken  " +cl.getContact(msg.from_).displayName + "😊aku Geffa😊"
                                cl.sendText(msg.to,beb)
		...
		if msg.from_ in Creator:
                    string = msg.text.replace("/cnMbok"," Mbok")
