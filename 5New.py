...
ka = LINETCR.LINE()
ka.login(token='EpNXG7DPqALvQM4PLzR9.mcgNJZM/LzspJccBd9bWwq.9qcmIHjObYsRCTlhiLZ0QdJNwBcvEFkhVYLxXIUm0f0=')
ka.loginResult()

kb = LINETCR.LINE()
kb.login(token='EprNj8HVoWJZDt5acOM5.x9stiL3M304dZxfq5Qx1Lq.+43hG87BfneOG33gLiIN+Z+XfkHfvZ5Xgc7lFuNxDtI=')
kb.loginResult()

kc = LINETCR.LINE()
kc.login(token='EprF74V3PgDJNJuVkhv4.AfXiUEwlH/LPi+AY4rWena.pmHKyD7f5V1qyznVTpnF2rjYgdCKe8kjBUsNzG3AggA=')
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token='EpZzKxrE4ZCfEe88Ukkf.1ZkEufVlAC998ZnedS4sxW.shHF+i7h9VdZ8WNjQDPGl0FELwRZAW8aCY4TwQMAxw0=')
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token='EpLR4ghTyaBqXbr7A9k1.0LG/m4b5Hl9w/in/aRu5Kq.ip2Y4vihlops2KMgEI8zl1UPvqLOrxPTSjLW2GHTa6Y=')
ke.loginResult()

backup = LINETCR.LINE()
backup.login(token='EqMFLx8hYDXv2qA6ZVGf.1CoDT6S0YL/Xx5N+7ZeeFW.rZ3aOkFHr1kvYAcu+Czg5zfqTaUglIqpV1UyKd/l2HU=')
backup.loginResult()
...
bayu=["ud5c39db7ab34ca5fb15f99ffef31047f","u39e89bf92deb47d7b9d4f213e1810dad"]
owner=["ud5c39db7ab34ca5fb15f99ffef31047f","u39e89bf92deb47d7b9d4f213e1810dad","udf6c3490f0e0f4205f088804076c03a0","u7347c230e0c899ad5b63ce75f572b106","u1db5875ab422e045f6133711b5103321"]
admin=["ud5c39db7ab34ca5fb15f99ffef31047f","u39e89bf92deb47d7b9d4f213e1810dad","udf6c3490f0e0f4205f088804076c03a0","u7347c230e0c899ad5b63ce75f572b106","u1db5875ab422e045f6133711b5103321"]
...
wait = {
    ...
    "autoAdd":True,
    "lang":"JP",
    "comment1":"😴Auto Like By zhu̶😭",
    "comment2":"😴Auto Like By zhu̶😭",
    "comment3":"😴Auto Like By zhu̶😭",
    "comment4":"😴Auto Like By zhu̶😭",
    "comment5":"😴Auto Like By zhu",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        ka.sendText(op.param1, "woy " + "[ " + Name + " ]" + "\nJangan Ngintip Aja\nSini ikutan Chat😁   ")
                                        time.sleep(0.2)
                                    ...
                                    ka.sendText(op.param1, "nah " + "☞ " + Name + " ☜" + "\n Ngintip Aja\nSini ikutan Gabung😁   ")
                                    time.sleep(0.2)
                                    summon(op.param1,[op.param2])
                        else:
                            pass
...
#==============================================================================#
            elif "zhueexpz" in msg.text:
              if msg.from_ in bayu:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("zhueexpz","")
                    gs = ka.getGroup(msg.to)
...
#==============================================================================#
            elif '/liric ' in msg.text.lower():
                try:
                    songname = msg.text.lower().replace('/liric ','')
                    params = {'songname': songname}
                    r = requests.get('http://ide.fdlrcn.com/workspace/yumi-apis/joox?' + urllib.urlencode(params))
                    data = r.text
                    data = json.loads(data)
...
#==============================================================================#
            ...
            elif ".cewek " in msg.text:
                apk = msg.text.replace(".cewek ","")
                rnd = ["Cewek","Cowok","Dipertanyakan"]
                p = random.choice(rnd)
                lang = 'id'
                tts = gTTS(text=p, lang=lang)
                tts.save("hasil.mp3")
                ...
                rnd = ["Biru","Pink","Hitam","Merah","Putih","Belang","Kuning"]
                p = random.choice(rnd)
                lang = 'id'
                tts = gTTS(text=p, lang=lang)
                tts.save("hasil.mp3")
